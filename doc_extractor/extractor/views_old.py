...
def msd(request):
    ...
    if doc_format == '.docx':
        ...
        status = {'status':'1','language': [lang],'file_name':[file_name]}
        extracted_categories = {**status,**final,**unique}
        return JsonResponse(extracted_categories)
...
#
# x , y = get_file_smb(r"\\chenfile05.asia.schawk.com\Tornado\TORNADO_TESTING\020_Supplied\A01\OLD\Book1.xlsx")
#
